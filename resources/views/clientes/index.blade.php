        ...
        <div class="card-body position-relative mt-4">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="mt-2">Administracion de clientes <b>para Thompson.</b> Aqui podras encontrar todos los
                        clientes admitidos, podras buscarlos por nombre, NIT, DUI o empresa.
                </div>
            </div>
        </div>
    </div>
