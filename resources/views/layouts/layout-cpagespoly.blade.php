...
<head>
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{url('vendors/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
  ...
  <body data-bs-spy="scroll" data-bs-target="#terms-sidebar" data-bs-offset="100" tabindex="0">
    ...
    <main class="main" id="top">
      ...
      <section class="py-0 pb-6 mb-4 overflow-hidden light" id="banner">
        ...
        <div class="bg-holder overlay" style="background-image:url({{asset('img/bg/pol-priv-img-bg-rt.png')}});background-position: center bottom;">
        </div>
        <!--/.bg-holder-->
