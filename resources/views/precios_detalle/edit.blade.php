...
@section('dashboard')
    ...
    <div class="card card-default">
        <div class="card-header">
            <span class="card-title">Actualizar precio de producto</span>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('precios_detalle.update', $precioDetalle->id) }}"  role="form" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                @csrf
