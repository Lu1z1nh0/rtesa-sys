                        ...
                        <div class="overflow-hidden">
                            ...
                            <div class="p-3">
                                <h5 class="fs-0"><a class="text-dark"
                                        href="../../../app/e-commerce/product/product-details.html">Canister</a></h5>
                                <p class="fs--1 mb-3"><a class="text-500" href="#!">Carro &amp; Accesorios</a></p>
                                <h5 class="fs-md-2 text-warning mb-0 d-flex align-items-center mb-3"> 87.99$
                                    <del class="ms-2 fs--1 text-500">97.99$ </del>
                                </h5>
                                <p class="fs--1 mb-1">Stock: <strong class="text-success">Disponible</strong>
                                </p>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center px-3">
                            <div>
                                <a href="{{ url('/dashboard/producto-detalle-test') }}">
                ...
                <div class="mb-4 col-md-6 col-lg-4">
                    <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                        <div class="overflow-hidden">
                            ...
                            <div class="p-3">
                                <h5 class="fs-0"><a class="text-dark"
                                        href="../../../app/e-commerce/product/product-details.html">Alternador</a></h5>
                                <p class="fs--1 mb-3"><a class="text-500" href="#!">Carro &amp; Accesorios</a></p>
                                <h5 class="fs-md-2 text-warning mb-0 d-flex align-items-center mb-3"> 90.99$
                                    <del class="ms-2 fs--1 text-500">105.99$ </del>
                                </h5>
                                <p class="fs--1 mb-1">Stock: <strong class="text-success">Disponible</strong>
                                </p>
                            </div>
                ...
                <div class="mb-4 col-md-6 col-lg-4">
                    <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                        ...
                        <div class="d-flex flex-between-center px-3">
                            <div>
                                <a href="{{ url('/dashboard/producto-detalle-test') }}">
                                    <button class="btn btn-primary me-1 mb-1" type="button"><i class="far fa-eye"></i>
                                        Ver
                                        producto
                                    </button>
                                </a>
